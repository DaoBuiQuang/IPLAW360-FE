...
function Application_VNListReport() {
  ...
  const handleExportExcel = async (customTitle, customFileName) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/application/export-excel`, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          reportTitle: customTitle || "BÁO CÁO DANH SÁCH ĐƠN ĐĂNG KÝ NHÃN HIỆU VIỆT NAM",
